...
```{r}
bcdf2<-bcdf
union_criterion<-bcdf$Relapse==1 | bcdf$Survival ==1
bcdf2$Mod_Relapse<-ifelse(bcdf$Relapse==1 | bcdf$Survival ==1,1,0)
bcdf2$Mod_Relapse_month2<-ifelse(bcdf2$Relapse==0 & bcdf2$Survival==1, Survival_month, Relapse_month)
```
